cmd_scripts/mod/mk_elfconfig := gcc -Wp,-MD,scripts/mod/.mk_elfconfig.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -Wno-unused-value -Wno-unused-parameter -Wno-missing-field-initializers -fno-delete-null-pointer-checks     -o scripts/mod/mk_elfconfig scripts/mod/mk_elfconfig.c  
...
deps_scripts/mod/mk_elfconfig := \
  ...
  /data/data/com.termux/files/usr/bin/../../usr/include/elf.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/linux/elf.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/linux/elf-em.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/bits/auxvec.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/linux/auxvec.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/aarch64-linux-android/asm/auxvec.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/aarch64-linux-android/asm/hwcap.h \
  /data/data/com.termux/files/usr/bin/../../usr/include/bits/elf_common.h \
